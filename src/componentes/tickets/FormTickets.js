...
const FormTickets = () => {
    ...
    return (
        ...
        <div className="container ">
              ...
              <h3>{titulo} Creación de  Tickets</h3>
              </div>
        ...
        <div class="card-body">
            ...
            <div class="px-5">
                <button  onClick={crearTicket} className="btn btn-outline-primary bi bi-rocket-takeoff-fill  my-2 my-sm-2 me-2" type="submit" >Crear Ticket</button>
